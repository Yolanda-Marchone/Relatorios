...
Route::get('/atividades_passadas', [App\Http\Controllers\AtividadesController::class, 'exibir_dados'])->name('layouts/atividadepassado')->middleware('auth');
...
Route::get('/plataforma_passadas', [App\Http\Controllers\PlataformaController::class, 'exibir_dados'])->name('layouts/cplataformapassado')->middleware('auth');
...
Route::get('/ver_relatorio', [App\Http\Controllers\PlataformaController::class, 'ver_relatorio'])->name('layouts/ver_relatorio')->middleware('auth');
