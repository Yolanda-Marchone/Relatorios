        ...
        <div class="col-md-8">
                ...
                <div class="col-auto">
                    <form class="docs-search-form row gx-1 align-items-center">
                        <div class="col-auto">
                            <input type="text" id="search-docs" name="searchdocs" class="form-control search-docs" placeholder="Procurar">
                        </div>
                        <div class="col-auto">
                ...
                <div class="col-auto">
                    ...
                    <select class="form-select w-auto">
                          ...
                          <option value="option-3">Excel</option>
                          <option value="option-4">Word</option>
...
<div class="row g-1">
    <div class="col-3 col-md-2 col-xl-1 col-xxl-2">
        <div class="app-card app-card-doc shadow-sm h-100">
            ...
            <div class="app-card-body p-3 has-card-actions">
                ...
                <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Relatório Dezembro</a></h4>
                <div class="app-doc-meta">
                    <ul class="list-unstyled mb-0">
                        <li><span class="text-muted">Tipo:</span> Texto</li>
                        <li><span class="text-muted">Tamanho:</span> 512KB</li>
                        <li><span class="text-muted">Carregado:</span> 3 mins</li>
                    </ul>
                </div><!--//app-doc-meta-->
        ...
        <div class="app-card-body p-3 has-card-actions">
            ...
            <div class="app-doc-meta">
                <ul class="list-unstyled mb-0">
                    ...
                    <li><span class="text-muted">Carregado:</span> 3 days</li>
                </ul>
            </div><!--//app-doc-meta-->
        ...
        <div class="app-card-body p-3 has-card-actions">
            ...
            <div class="app-doc-meta">
                <ul class="list-unstyled mb-0">
                    ...
                    <li><span class="text-muted">Carregado:</span> 1 week ago</li>
                </ul>
            </div><!--//app-doc-meta-->
